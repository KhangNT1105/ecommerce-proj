...
<body>
  <div class="form-panel" >
              ...
              <form class="form-horizontal style-form " method="POST" action="./product-HandleUpdate.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Mã sản phẩm</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="product_id" value="<?php echo $t['product_id']; ?>">
                  </div>
                </div>
                <div class="form-group">
                 <label class="col-sm-2 col-sm-2 control-label">Tên sản phẩm</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="product_name" value="<?php echo $t['product_name']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <select name="pro_cate_id" id="" class="form-control">
                      <?php foreach($dataLoais as $r)
                                {
                                    ?>
                                    <option <?php if($r['pro_cate_id'] ==$t['pro_cate_id']) echo "selected=\"selected\""; ?>
                                     value="<?php echo $r['pro_cate_id'] ?>"><?php echo $r['pro_cate_name'] ?></option>
                                    <?php
                                }
                                ?>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="status" value="<?php echo $t['status']; ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <button class="btn btn-primary"type="submit" name="btnUpdate" value="Update" >
                    Cập nhật
                </button>
              </form>
            </div>
